...
from practice1.main import Color, DCT, DWT
...
class TestColorMethods(unittest.TestCase):
    def test_rgb_to_yuv_and_back(self):
        ...
        self.assertAlmostEqual(yuv_color.x, 41.0, places=1)
        self.assertAlmostEqual(yuv_color.y, 240.0, places=1)
        self.assertAlmostEqual(yuv_color.z, 110.0, places=1)

        rgb_back = yuv_color.yuv_to_rgb(yuv_color.x, yuv_color.y, yuv_color.z)
        self.assertAlmostEqual(rgb_back.x, 1, places=1)
        self.assertAlmostEqual(rgb_back.y, 0, places=1)
        self.assertAlmostEqual(rgb_back.z, 255, places=1)
